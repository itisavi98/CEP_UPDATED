// frontend/src/views/components/Footer.jsx
      ...
      <div className="footer-container">
        <div className="footer-top">
          ...
          <div className="footer-column">
            <h3 className="footer-logo">🏢 DreamLand Realty</h3>
            <p className="footer-description">
              Your trusted partner in finding the perfect property.
              With 25+ years of experience, we deliver excellence in real estate.
            </p>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              {[['about','About Us'],['commercial','Commercial'],['residential','Residential'],['plotting','Plotting'],['ongoing','Ongoing Projects'],['projects','Completed Projects']].map(([id,label]) => (
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              {[['clients','Client Testimonials'],['gallery','Gallery'],['faq','FAQ'],['contact','Contact Us']].map(([id,label]) => (
                <li key={id}><button onClick={() => scrollTo(id)}>{label}</button></li>
              ))}
              <li><a href="#property-management">Property Management</a></li>
              <li><a href="#home-loans">Home Loan Assistance</a></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact">
              <li>
                ...
                <span>123 Real Estate Avenue<br/>Mumbai, Maharashtra 400001</span>
              </li>
              <li>
              ...
              <li>
                ...
                <span>info@dreamlandrealty.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">© {currentYear} DreamLand Realty. All rights reserved.</p>
